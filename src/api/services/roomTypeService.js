...
const roomTypeService = {
  createRoomType: async (roomTypeData) => {
    try {
      const response = await apiClient.post('/room_types', roomTypeData);
  ...
  getAllRoomTypes: async (params = {}) => {
    try {
      const response = await apiClient.get('/room_types', { params });
  ...
  getRoomTypeById: async (roomTypeId) => {
    try {
      const response = await apiClient.get(`/room_types/${roomTypeId}`);
  ...
  updateRoomType: async (roomTypeId, updateData) => {
    try {
      const response = await apiClient.patch(`/room_types/${roomTypeId}`, updateData);
  ...
  deleteRoomType: async (roomTypeId) => {
    try {
      const response = await apiClient.delete(`/room_types/${roomTypeId}`);
  ...
  searchRoomTypes: async (searchParams = {}) => {
    try {
      const response = await apiClient.get('/room_types/search', { params: searchParams });
