...
// Mock data for visits (lịch thăm)
export const visits = [
  {
    id: 'visit_001',
    family_member_id: 'f1',
    ...
    numberOfVisitors: 2,
    notes: 'Mang theo cháu nội đến thăm',
  },
  {
    id: 'visit_002',
    family_member_id: 'f1',
    ...
    duration: 60,
    status: 'completed',
    purpose: 'Thăm hỏi và trao đổi với bác sĩ',
    numberOfVisitors: 1,
    notes: 'Mang kết quả xét nghiệm',
  },
  {
    id: 'visit_003',
    family_member_id: 'f2',
  ...
  },
  {
    ...
    duration: 60,
    status: 'completed',
    purpose: 'Thăm hỏi và mang quà sinh nhật',
    numberOfVisitors: 3,
    notes: 'Mang bánh sinh nhật',
  },
  {
    id: 'visit_005',
    family_member_id: 'f1',
    visit_date: '2024-04-25',
    visit_time: '16:00',
    duration: 120,
    status: 'completed',
    purpose: 'Thăm hỏi cuối tuần',
    numberOfVisitors: 4,
    notes: 'Cả gia đình cùng đến',
  },
  {
    id: 'visit_006',
    family_member_id: 'f2',
  ...
  },
  {
    ...
    duration: 90,
    status: 'completed',
    purpose: 'Thăm hỏi và trao đổi với điều dưỡng',
    numberOfVisitors: 1,
    notes: '',
  },
];
